	...
	return (
		<div className="relative">
			...
			{!isLoaded && (
				<div
					...
					style={{
						width: width,
						height: height,
						background: bgColor || 'linear-gradient(90deg, #f0f0f0 25%, #e0e0e0 50%, #f0f0f0 75%)',
			...
			<NextImage
				...
				height={height}
				alt={alt}
				className={`select-none drag-none transition-opacity duration-300 ${isLoaded ? 'opacity-100' : 'opacity-0'
					} ${className}`}
