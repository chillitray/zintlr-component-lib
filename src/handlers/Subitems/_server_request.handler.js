...
import { ErrorObject } from './request-handler.js';
import { getIP, verify_and_decrypt_jwt } from './_common.handler.js';
...
export function serverRequestHandler({
  ...
  data = {
    ...
    ...data,
    ...(isSourceRequired && {
      source: process.env.NEXT_PUBLIC_PLATFORM_SOURCE,
    }),
  };
  ...
  if (isAuthRequired) {
    ...
    const access_token = verify_and_decrypt_jwt(
